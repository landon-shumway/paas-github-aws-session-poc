...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(544))
  }
}
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(738);
...
var node_domexception = __nccwpck_require__(244);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(169);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(738);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(679);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(738);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(169);
...
var esm_min = __nccwpck_require__(506);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 357).then(__nccwpck_require__.bind(__nccwpck_require__, 357));
...
var from = __nccwpck_require__(954);
...
(async () => {
  ...
  const roleArn = core_default().getInput("roleArn", { required: true });
  const transitiveTags = core_default().getInput("transitiveTags");
  ...
  core_default().setSecret(SecretAccessKey);
  core_default().setSecret(SessionToken);

  core_default().exportVariable("AWS_ACCESS_KEY_ID", AccessKeyId);
  core_default().exportVariable("AWS_SECRET_ACCESS_KEY", SecretAccessKey);
  core_default().exportVariable("AWS_SESSION_TOKEN", SessionToken);
})();
